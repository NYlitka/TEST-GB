...
$mainmass = [
	[
      ...
      "description" => "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in 
       deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde 
  ...
  <div class="w3-content w3-margin-top" style="max-width:1400px;">
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
       ...
       <?php for($i = 0;$i < count($mainmass);$i++): ?>
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $mainmass[$i]["name"]?></b></h5>
            <h6 class="w3-text-teal">
            <i class="fa fa-calendar fa-fw w3-margin-right"></i>
           <?php echo $mainmass[$i]["dateStart"]?> - 
           <?php if($i == 0):?>
             <span class="w3-tag w3-teal w3-round"> 
           <?php echo $mainmass[$i]["dateEnd"];?>
             </span>
             <?php else: ?>
             <?=$mainmass[$i]["dateEnd"]; ?>
             <?php endif; ?>
           
           </h6>Current</span></h6></span></h6>
           <p><?php echo $mainmass[$i]["description"]?></p>
            <hr>
          </div>
       <?php endfor;?>
        </div>
