...
* *-M main* -название базовой ветки
* *git remote add origin* -привязать локальный диапозиторий к githab
* *git push -u origin main -слить локальную версию в hab и одновременно создать в удаленном диапозитории ветку с тем же названием - main 
